namespace Vectores_Ejercicio_07
{
    internal class Vectores_Ejercicio_07
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Bienvenido/a, por favor ingrese 5 numeros para el primer vector");
            ...
            Console.WriteLine("Por favor ingrese 5 numeros para el segundo vector");
