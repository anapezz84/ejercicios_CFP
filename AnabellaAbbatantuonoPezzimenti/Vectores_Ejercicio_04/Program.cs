namespace Vectores_Ejercicio_04
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Bienvenido/A al sistema de cargas de Array");
            Console.WriteLine("Por favor ingrese la palabra que quiere pasar a array");
