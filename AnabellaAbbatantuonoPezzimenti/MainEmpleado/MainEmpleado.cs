...
namespace MainEmpleado
{
    public class MainEmpleado
    {
        ...
        {
            Empleado gerente1 = new Gerente("Fernando", 2000, "Turismo", 10, 50);
            Empleado desarrollador1 = new Desarrollador("Anabella", 300, "Analitics", 1, "C#", 3);
            Empleado analista1 = new Analista("Roxana", 500, "Turismo", 3, "Javascript", "nueva Web 2.0");
            ...
            foreach (Empleado item in listaEmpleados)
            {
                ...
                Console.WriteLine($"Su ganancia total es de: ${item.SalarioTotal()}");
                Console.WriteLine("--------");
            }
