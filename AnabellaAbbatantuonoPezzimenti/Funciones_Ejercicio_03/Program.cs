namespace Funciones_Ejercicio_03
{
    internal class Funciones_Ejercicio_03
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Bienvenido/a, ingrese un valor: ");
            valor = int.Parse(Console.ReadLine());

            Console.WriteLine("Por favor ingrese un porcentaje: ");
